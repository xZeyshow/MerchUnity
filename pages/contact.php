...
<head>
    ...
    <link href="../css_pages/style.css" rel="stylesheet" />
     ...
     <link href="../css_pages/login.css" rel="stylesheet" />
...
<!-- Formulaire -->
  ...
  <form action="contact.php" method="POST" class="mx-auto mt-8 max-w-xl sm:mt-20">
    ...
    <div class="mt-10">
      <button type="submit" name="submit" class="block w-full rounded-md bg-indigo-600 px-3.5 py-2.5 text-center text-sm font-semibold text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">Envoyer</button>
    </div>
  </form>
</div>
